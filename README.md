...
3. In order to meet the project requirements, I plan on using at least 4 APIs which will each have their own route. The current 4 I plan on using are the Mars Rover, EPIC, NASA Image and Video Library, and APOD APIs. 
